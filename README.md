About periodicgw-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/periodicgw-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14902&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/periodicgw-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `periodicgw` can be installed with `conda`:
...
```
mamba install periodicgw
```

It is possible to list all of the versions of `periodicgw` available on your platform with `conda`:
...
```
mamba search periodicgw --channel conda-forge
```
...
mamba repoquery search periodicgw --channel conda-forge

# List packages depending on `periodicgw`:
mamba repoquery whoneeds periodicgw --channel conda-forge

# List dependencies of `periodicgw`:
mamba repoquery depends periodicgw --channel conda-forge
```
